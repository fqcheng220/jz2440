...
//发送寄存器
#define UTXH0_L *((unsigned int*)0x50000020)
#define UTXH0_B *((unsigned int*)0x50000023)
//接收寄存器
#define URXH0_L *((unsigned int*)0x50000024)
#define URXH0_B *((unsigned int*)0x50000027)
//状态寄存器
